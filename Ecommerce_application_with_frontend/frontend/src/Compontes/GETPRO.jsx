...
function GETPRO() {
  ...
  return (
    <div className="d-flex flex-column flex-lg-row bg-dark" style={{height:` auto`}}>
      ...
      <div className="col-12 col-lg-8 ms-4">
        <div className="py-4">
          <h1 className="text-white mb-4">Product List</h1>
          ...
          {loading ? (
              ...
              {[...Array(6)].map((_, index) => (
                <div className="col-12 col-sm-6 col-md-4 col-lg-3 mb-3" key={index}>
                  <div className="card bg-dark text-white shadow-sm">
                    <div className="card-img-top skeleton-placeholder" style={{ height: "200px" }}></div>
            ...
            <div className="row ">
              {state.map((el) => (
                <div className="col-12 col-sm-6 col-md-4 col-lg-3 mb-3 m-2 " key={el._id}>
                  <div className="card bg-dark text-white shadow-sm">
                    <img
                    ...
                    <div className="card-body">
                      ...
                      <h6 className="card-text text">Price : ₹ {el.price}</h6>
                    </div>
                    <div className="card-footer d-flex justify-content-between">


                      <button className="button" onClick={() => handledelete(el._id)} >
                        <svg
                      ...
                      <button className="editBtn m-1" onClick={() => handleedite(el._id)}>
